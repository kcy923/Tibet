	...
	<section>
		...
		<div class="checkbox-group">
			<div class="check-parent">
				<input type="checkbox" name="check-Agree" class="normal" onclick="selectAll(this)">
				<label>전체 동의</label>
			</div>
			...
			<div class="check-child">
				<input type="checkbox" name="user_mailSend" value='1' class="normal" id="user_mailSend"/> <label>마케팅 수신 동의</label>
