        ...
        <div class="enter-table-not mgb15">
            ...
            <p><br></p>
				<div class="enter-table-file">
					<c:choose>
						<c:when test="${notice.notice_img1 eq null || notice.notice_img1 eq ''}"></c:when>
						<c:otherwise>
							<div>
					...
					<c:choose>
						<c:when test="${notice.notice_img2 eq null || notice.notice_img2 eq ''}"></c:when>
						<c:otherwise>
							<div>
								<img alt="#" src="resources/img/${notice.notice_img1}">
							</div>
					...
					<c:choose>
						<c:when test="${notice.notice_img3 eq null || notice.notice_img3 eq ''}"></c:when>
						<c:otherwise>
							<div>
